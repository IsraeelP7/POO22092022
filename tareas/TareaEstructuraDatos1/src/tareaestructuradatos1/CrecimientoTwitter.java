 ...
 * @author israelpsiu7
 */
public class CrecimientoTwitter {
    
    private float mes1= 1;
    private float mes2= 1;
    private float mes3= 1;
    private float mes4= 2;
    private float mes5= 1;
    private float mes6=1;

    public CrecimientoTwitter() {
    }
    ...
    public String toString() {
        return "CrecimientoTwitter{" + "mes1=" + mes1 + ", mes2=" + mes2 + ", mes3=" + mes3 + ", mes4=" + mes4 + ", mes5=" + mes5 + ", mes6=" + mes6 + '}';
    }

    public void promedioCrec(){
        System.out.println("");
        System.out.println("Crecimiento promedio en Twitter");
